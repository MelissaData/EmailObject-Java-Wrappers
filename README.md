# Melissa - Email Object Java Wrappers

## Purpose

This is the code for you to run Email Object in Java.
...
## Getting Started
These instructions will get you a copy of the wrappers needed to run the Java Email Object on your local machine. 

### Download this project
```
$ git clone https://github.com/MelissaData/EmailObject-Java-Wrappers.git
$ cd EmailObject-Java-Wrappers
```

### Copy wrappers to your project folder
Import the `com` folder, and `mdEmailJavaWrapper.dll` (Windows) or `libmdEmailJavaWrapper.so` (Linux) to your project, and include the following line in your code to begin using the wrapper.
...
#### Configure Scripts
If you want to generate `mdEmailJavaWrapper.dll`, you will execute the `BuildEmailJavaWrapper.ps1` script. This may require you to configure some path variables in `BuildWrapper.ps1` and `BuildEmailJavaWrapper.ps1`.
...
It is important to note that you must be able to initialize the Visual Studio Developer Command Prompt environment for `x86_x64` to generate `mdEmailJavaWrapper.dll`.
...
#### Configure Script
If you want to generate `libmdEmailJavaWrapper.so`, you will execute the `BuildEmailJavaWrapper.sh` script. This may require you to configure some path variables in `BuildEmailJavaWrapper.sh`.
...
----------------------------------------
## See also
- [Melissa - Email Object Windows Java](https://github.com/MelissaData/EmailObject-Java)
- [Melissa - Email Object Linux Java](https://github.com/MelissaData/EmailObject-Java-Linux)

...
- Melissa Email Object for 2026-08
...
#### Configure Scripts
If you want to generate `mdEmailJavaWrapper.dll`, you will execute the `BuildEmailJavaWrapper.ps1` script. This may require you to configure some path variables in `Build.ps1` and `BuildEmailJavaWrapper.ps1`.

...
gcc -fpic -c -I$mdEmailPath -I$JavaIncludeDirectory1 -I$JavaIncludeDirectory2 mdEmailJavaWrapper.cpp
gcc -g -shared mdEmailJavaWrapper.o -o libmdEmailJavaWrapper.so -L$mdEmailPath -lmdEmail -pthread 
